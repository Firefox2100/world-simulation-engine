...
async def experiment_director_agent(director: DirectorAgent,
    ...
    example_simulation_state.recent_history_summary=\
        ("Arthur arrived at the Iron Stag Inn during the Founder's Festival. Clara "
        ...
        "anonymous letter.")
    example_simulation_state.long_term_history_summary=\
        ("Director Harlan disappeared three weeks ago. Officially he left without "
    ...
    example_simulation_state.recent_history_summary=\
        ("Arthur has established a cautious rapport with Clara. Clara is curious about "
        ...
        "unknown visitor.")
    example_simulation_state.long_term_history_summary=\
        ("An unknown visitor stayed in Room 7 shortly before Harlan disappeared. "
    ...
    example_simulation_state.recent_history_summary=\
        ("Arthur has just arrived and has not committed to a line of questioning. Clara is "
        "attentive but not yet directly engaged. Eleanor is no longer immediately "
        "pressing him.")
    example_simulation_state.long_term_history_summary=\
        ("The investigation is still at its opening stage. Arthur has possible leads: "
    ...
    example_simulation_state.recent_history_summary=\
        ("Arthur questioned Clara about the unknown visitor. Clara did not deny that Room "
        "7 mattered. The ledger suggests the visitor used a false name and paid in cash.")
    example_simulation_state.long_term_history_summary=\
        ("Room 7 was occupied by an unknown visitor shortly before Harlan disappeared. "
    ...
    example_simulation_state.recent_history_summary=\
        ("Arthur has started probing the Room 7 lead. Clara is conflicted between "
        "curiosity, caution, and her control over inn gossip. Eleanor may become concerned "
        "if Arthur gains momentum too quickly.")
    example_simulation_state.long_term_history_summary=\
        ("The town is trying to preserve the appearance of normal festival order despite "
