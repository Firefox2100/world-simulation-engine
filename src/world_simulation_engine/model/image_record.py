...
class ImageRecordCreate(BaseModel):
    simulation_id: int = Field(
        ...,
        description="The simulation ID for which the image is generated"
    )
    target: str = Field(
        ...,
        description="The target of the image"
    )
    category: str = Field(
        ...,
    ...
    target_id: int = Field(
        ...,
        description="The target ID of the image"
    )

    spec: ImageSpec = Field(
        ...,
        description="The actual spec used to generate this image"
    )
...
class ImageRecord(ImageRecordCreate):
    id: int = Field(
        ...,
        description="The unique ID of the image record. Generated by the database"
    )
