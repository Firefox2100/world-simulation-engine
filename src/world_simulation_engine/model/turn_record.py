...
class TurnRecordCreate(BaseModel):
    ...
    character_actions: list[CharacterActionOutput] = Field(
        default_factory=list,
        description="Character agents output for this turn record."
    )
    character_reactions: list[CharacterActionOutput] = Field(
        default_factory=list,
        description="Character agent reactions for this turn record."
    )
    resolver_output: Optional[ResolverOutput] = Field(
        None,
        description="Resolver output for this turn record."
    )
    reaction_resolving: Optional[ResolverOutput] = Field(
        None,
        description="Reaction resolving output for this turn record."
    )
    committer_output: Optional[CommitterFinalOutput] = Field(
        None,
        description="Committer output for this turn record."
    )
    narration: str = Field(
        ...,
        description="The narration for this turn. Can be the user input, or the final AI narration."
    )
    summary_output: Optional[SummaryOutput] = Field(
        None,
        description="Summary output for this turn record."
    )


class TurnRecord(TurnRecordCreate):
    id: int = Field(
        ...,
