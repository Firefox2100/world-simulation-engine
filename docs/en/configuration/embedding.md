...
The embedding driver now supports Ollama, OpenAI, AI21, Google GenAI, Mistral AI, Cohere, Perplexity, and Cloudflare Workers AI. Providers whose LangChain integration does not expose an embedding class, such as Anthropic, OpenRouter, Groq, DeepSeek, and xAI, are intentionally not shown in the embedding picker.
...
| AI21 | Batch size and retry count. |
